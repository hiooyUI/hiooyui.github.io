	...
	<div style={{margin: '15px 0'}}>
		<dl className="clearfix">
			...
			<dd>
				...
				<p style={{ marginTop: 15, paddingLeft: 20}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;纸张尺寸的这个系统的价值是每个尺寸与下一个尺寸成比例。 A4纸例如大约21厘米×29.7厘米（大约8.27英寸×11.75英寸），而A3是29.7厘米×42厘米（大约11.75英寸×16.5英寸）。 如果有人在一张A4纸上放置了文字或图像，并想把它放大到A3纸上，可以很容易地完成，而不会丢失文档的任何内容。 这个使用2的平方根（即1.414）的比例被称为Lichtenberg比率，以德国物理学家的名字命名，他首先指出了它的用处。
					</p>
